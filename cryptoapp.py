...
image = Image.open('wp.jpg')

st.image(image, width = 500)

st.title('Crypto Price App')
st.markdown("""
This app retrieves cryptocurrency prices for the top 50 cryptocurrency from the **crypto.com**!
""")
#---------------------------------#
# About
...
* **Credit:** (https://towardsdatascience.com/web-scraping-crypto-prices-with-python-41072ea5b5bf)* written by [Bryan Feng](https://medium.com/@bryanf).
""")
